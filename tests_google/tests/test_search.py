...
class TestSearch(BaseTest):
    ...
    def test_search_term(self, setup_test):
        ...
        print(f'{bcolors.OKBLUE}INFO: About {search_result_only} results were found{bcolors.ENDC}')
        ...
        print(f'{bcolors.OKBLUE}INFO: {results_amount} results of search can be seen on the first page. Images, videos and articles were not included{bcolors.ENDC}')
        try:
            assert results_amount >= 10
        except AssertionError:
            print(f'{bcolors.FAIL}INFO: on first page, less then 10 results are dispalyed{bcolors.ENDC}')
        ...
        try:
            ...
            print(f'{bcolors.FAIL}INFO: {err}{bcolors.ENDC}')
        finally:
            if is_image_section_visble:
                ...
                print(f'{bcolors.FAIL}INFO: no images loaded, image section is not visible{bcolors.ENDC}')